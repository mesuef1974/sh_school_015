# Generated by Junie (JetBrains) to apply DB best-practices suggestions
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=Q(day_of_week__gte=1) & Q(day_of_week__lte=5),
        ...
        migrations.AddConstraint(
            model_name="timetableentry",
            constraint=models.CheckConstraint(
                check=Q(period_number__gte=1) & Q(period_number__lte=7),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=Q(day_of_week__gte=1) & Q(day_of_week__lte=7),
