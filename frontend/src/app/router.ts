...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/students/absence', name: 'students-absence', component: () => import('../features/students/StudentsAbsenceHub.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'] } },
  { path: '/attendance/procedures', name: 'attendance-procedures', component: () => import('../features/attendance/pages/AttendanceProcedures.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'] } },
