...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/demo', name: 'demo', component: () => import('../features/demo/DemoPage.vue'), meta: { titleAr: 'عرض تجريبي' } },
  { path: '/design-system', name: 'design-system', component: () => import('../features/design/DesignSystemPage.vue'), meta: { titleAr: 'نظام التصميم' } },
  { path: '/me', name: 'profile', component: () => import('./pages/ProfilePage.vue'), meta: { requiresAuth: true, titleAr: 'ملفي' } },
  { path: '/stats', name: 'stats', component: () => import('../features/stats/StatsPage.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'الإحصائيات' } },
  { path: '/students', name: 'students', component: () => import('../features/students/StudentsPage.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'الطلاب' } },
  { path: '/students/absence', name: 'students-absence', component: () => import('../features/students/StudentsAbsenceHub.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'إدارة غياب الطلاب' } },
  { path: '/attendance/procedures', name: 'attendance-procedures', component: () => import('../features/attendance/pages/AttendanceProcedures.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'إجراءات الحضور' } },
  { path: '/attendance/teacher', name: 'teacher-attendance', component: TeacherAttendance, meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'تسجيل الغياب' } },
  { path: '/attendance/teacher/history', name: 'teacher-attendance-history', component: () => import('../features/attendance/pages/TeacherAttendanceHistory.vue'), meta: { requiresAuth: true, requiredRoles: ['teacher'], titleAr: 'سجل الغياب' } },
  { path: '/wing/dashboard', name: 'wing-dashboard', component: () => import('../features/wings/pages/WingDashboard.vue'), meta: { requiresAuth: true, requiredRoles: ['wing_supervisor'], titleAr: 'لوحة جناح' } },
  { path: '/wing/approvals', name: 'wing-approvals', component: () => import('../features/wings/pages/WingApprovals.vue'), meta: { requiresAuth: true, requiredRoles: ['wing_supervisor'], titleAr: 'طلبات الاعتماد' } },
  { path: '/attendance/wing/monitor', name: 'wing-attendance-monitor', component: () => import('../features/wings/pages/WingAttendanceMonitor.vue'), meta: { requiresAuth: true, requiredRoles: ['wing_supervisor'], titleAr: 'مراقبة حضور الجناح' } },
