<template>
  <div class="page-container">
    ...
    <header class="navbar-maronia">
      <nav
        class="container d-flex align-items-center gap-3 py-2"
        role="navigation"
      ...
      >
        ...
        <div class="dropdown" v-if="auth.profile">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li v-if="isAssignedTeacher || isSuper">
              <h6 class="dropdown-header">صفحات المعلم</h6>
            </li>
            <li v-if="isAssignedTeacher || isSuper">
              <RouterLink class="dropdown-item" to="/">الرئيسية</RouterLink>
            </li>
            <li v-if="isAssignedTeacher || isSuper">
              <RouterLink class="dropdown-item" to="/attendance/teacher">تسجيل الغياب</RouterLink>
            </li>
            <li v-if="isAssignedTeacher || isSuper">
              <RouterLink class="dropdown-item" to="/timetable/teacher">جدولي</RouterLink>
            </li>
            <li v-if="isAssignedTeacher || isSuper">
              <RouterLink class="dropdown-item" to="/attendance/teacher/history"
                >سجل الغياب</RouterLink
              >
            </li>
            ...
            <li><hr class="dropdown-divider" /></li>
            <li>
              <a class="dropdown-item text-danger" href="#" @click.prevent="onLogout"
                >تسجيل الخروج</a
              >
            </li>
          </ul>
    ...
    <main
      ...
      :class="{ 'wide-wing': isWing, 'is-login': isLogin, 'py-3': !isLogin }"
      role="main"
      tabindex="-1"
    >
      <div
    ...
    <footer class="page-footer py-3 bg-maroon">
      <div class="container d-flex justify-content-between small">
        <span class="text-gold-metal text-center w-100"
          >©2025 - جميع الحقوق محفوظة - مدرسة الشحانية الاعدادية الثانوية بنين - تطوير( المعلم/
          سفيان مسيف s.mesyef0904@education.qa )</span
        >
      </div>
    </footer>
  </div>
...
.btn-glass-home:focus {
  outline: 2px solid rgba(138, 21, 56, 0.3);
  outline-offset: 2px;
}
.btn-glass-home :deep(svg) {
  font-size: 18px;
}
</style>
