  ...
  <section class="d-grid gap-3 page-grid page-grid-wide" dir="rtl">
    <div class="d-flex align-items-center gap-2 mb-2 header-bar frame">
      ...
      <div>
        ...
        <div class="text-muted small" v-else>حصص بلا إدخال — شريط العنوان فقط (Placeholder)</div>
      </div>
...
const tileMeta = computed(() => tiles.find((t) => t.to === "/wing/attendance/missing") || { title: "حصص بلا إدخال", icon: "solar:warning-bold-duotone", color: "#f39c12" });
