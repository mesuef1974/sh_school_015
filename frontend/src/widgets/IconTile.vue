...
.tile:hover { transform: translateY(-3px); box-shadow: 0 12px 28px rgba(0,0,0,.10); }
.tile:active { transform: translateY(-1px) scale(0.995); }
.tile:focus-visible { outline: 2px solid rgba(138,21,56,0.25); outline-offset: 2px; }
...
.tile-subtitle { font-size:.86rem; color:#667085; line-height:1.2; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }

/* شارة KPI بلون البلاطة */
.tile-badge {
  position:absolute; inset-inline-end:10px; top:10px;
  background: var(--tc);
  color:#fff; border-radius:999px; padding:2px 8px; font-size:.75rem;
  box-shadow: 0 4px 10px rgba(0,0,0,.12);
}

/* تحسينات استجابة */
@media (max-width: 576px) {
  .tile { width: 84%; padding:14px; }
  .tile-icon { width:68px; height:68px; font-size:32px; border-radius:18px; }
}
