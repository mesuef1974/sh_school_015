...
.icon-wrap { width: 44px; height: 44px; background: rgba(123,30,30,.08); color: var(--maron-primary); }
.kpi-danger .icon-wrap { background: rgba(220,53,69,.08); color: #dc3545; }
.kpi-warning .icon-wrap { background: rgba(255,193,7,.12); color: #b58100; }
.kpi-secondary .icon-wrap { background: rgba(108,117,125,.12); color: #6c757d; }
</style>