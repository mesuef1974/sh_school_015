...
# Suppress third-party migrate-time warning from docxcompose about pkg_resources deprecation.
# This is a narrow filter that only ignores that specific UserWarning emitted by docxcompose.properties
# during manage.py operations (makemigrations/migrate). It does not mask other warnings.
...
try:
    ...
    sys.stderr.write("Error: Django is not installed or failed to import.\n" f"Details: {e}\n")
    sys.exit(1)
